...
export function AddNewApplication() {
  ...
  const fileTypes = ["JPEG", "PNG", "GIF", "JPG", "MP4", "PDF", "PSD"];
  ...
  useEffect(() => {
    ...
    applicationsData?.applicant?.fileUpload &&
      setDocumentFile([applicationsData?.applicant?.fileUpload]);
          ...
          <div className="rounded-[34px] bg-white p-[39px]">
            ...
            <div className="mt-12 mb-6 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <div>
                ...
                >
                  <option value={formValues?.fullName || ""}>
                    {formValues?.fullName || "Select Name"}
                  </option>
        ...
        <div className="w-20 h-20 flex items-center justify-center bg-gray-200">
          {files[0].type.startsWith("image/") && (
            <div className="flex justify-center items-center h-full w-full">
              <a href={URL.createObjectURL(files[0])} target="_blank" className="w-20 h-20">
                <img
            ...
            <div className="my-[30px] rounded-[34px] bg-white p-[39px] ">
              ...
              <div className="grid grid-cols-1 gap-[20px] xl:grid-cols-2">
                <FileUploader
                  ...
                  types={fileTypes}
                  // disabled={isViewMode}
                  disabled={documentFile.length > 2}
                >
                  <img
                ...
                <div className="w-full items-center">
                  <div className="">
                    <p className=" text-sm font-semibold text-[#92929D]">
                      ...
                      {/* Uploading - {documentFile.length >= 4 ? "maximum files reached": documentFile.length }/3 files */}
                    </p>
                  </div>
                  <div className="my-5">
                    {documentFile.length > 0 ? (
                      documentFile.map((files) => (
                        <div className="my-2 flex items-center space-x-4">
                          <div className="flex w-full flex-row items-center justify-between rounded-lg p-3 outline outline-1 outline-[#11AF22]">
                            <p className="text-xs text-black ">
                              {files[0].name}
                            </p>
                          </div>
                          <div
                            className="flex cursor-pointer flex-row items-center justify-between rounded-lg p-3 text-xs text-[#f85a5a] outline outline-1 outline-[#f85a5a]"
                            onClick={(e) => {
                              e.preventDefault();
                              const index = documentFile.indexOf(files);
                              alert(`change file at index ${index}`);
                            }}
                          >
                            Rename
                          </div>
                          <div
                            className="flex cursor-pointer flex-row items-center justify-between rounded-lg p-3 text-xs outline outline-1 outline-[#8b8c8b]"
                            onClick={(e) => {
                              e.preventDefault();
                              setDocumentFile((prev) =>
                                prev.filter((ele) => ele !== files)
                              );
                            }}
                          >
                            Delete
                  ...
                  {isViewMode ? (
                    ...
                    <Button
                      className="cursor-pointer  rounded-[15px] bg-[#280559] disabled:bg-black"
                      // disabled={isViewMode}
                      disabled={documentFile.length > 2}
                    >
                      <div className="flex cursor-pointer flex-row items-center justify-center">
                        ...
                        <FileUploader
                          ...
                          types={fileTypes}
                        >
                          <p className="cursor-pointer p-1 px-[11px] text-base font-medium normal-case text-white">
                            Upload Document
                          </p>
                        </FileUploader>
                      </div>
